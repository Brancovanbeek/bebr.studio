...
export default {
  name: 'questionsSection',              // â† Verander naar bijv. 'aboutSection'
  title: 'Questions section',            // â† Verander naar bijv. 'About Sectie'
  type: 'object',
  fields: [
    {
      name: 'heading',
  ...
  preview: {
    prepare() {
      return {
        title: 'Questions section'  // â† Verander naar bijv. 'About Sectie' (zelfde als hierboven)
      }
    }
  }
}
