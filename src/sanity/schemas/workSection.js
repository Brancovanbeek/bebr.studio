...
export default {
  name: 'workSection',              // â† Verander naar bijv. 'aboutSection'
  title: 'Work section',            // â† Verander naar bijv. 'About Sectie'
  type: 'object',
  fields: [
    {
      name: 'heading',
  ...
  preview: {
    prepare() {
      return {
        title: 'Work section'  // â† Verander naar bijv. 'About Sectie' (zelfde als hierboven)
      }
    }
  }
}
