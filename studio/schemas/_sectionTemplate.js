...
export default {
  name: 'mijnSectie',              // ← Verander naar bijv. 'aboutSection'
  title: 'Mijn Sectie',            // ← Verander naar bijv. 'About Sectie'
  type: 'object',
  fields: [
    {
      name: 'heading',
  ...
  preview: {
    prepare() {
      return {
        title: 'Mijn Sectie'  // ← Verander naar bijv. 'About Sectie' (zelfde als hierboven)
      }
    }
  }
}
