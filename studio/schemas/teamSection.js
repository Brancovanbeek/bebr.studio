...
export default {
  name: 'teamSection',              // ← Verander naar bijv. 'aboutSection'
  title: 'Team section',            // ← Verander naar bijv. 'About Sectie'
  type: 'object',
  fields: [
    {
      name: 'heading',
  ...
  preview: {
    prepare() {
      return {
        title: 'Team section'  // ← Verander naar bijv. 'About Sectie' (zelfde als hierboven)
      }
    }
  }
}
