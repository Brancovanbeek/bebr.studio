...
export default {
  name: 'workSection',              // ← Verander naar bijv. 'aboutSection'
  title: 'Work section',            // ← Verander naar bijv. 'About Sectie'
  type: 'object',
  fields: [
    {
      name: 'heading',
  ...
  preview: {
    prepare() {
      return {
        title: 'Work section'  // ← Verander naar bijv. 'About Sectie' (zelfde als hierboven)
      }
    }
  }
}
